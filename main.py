...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.entry = customtkinter.CTkEntry(self, placeholder_text="Prediction")
        self.entry.grid(row=3, column=1, columnspan=2, padx=(20, 0), pady=(20, 20), sticky="nsew")

        self.main_button_1 = customtkinter.CTkButton(master=self, fg_color="transparent", border_width=2, text_color=("gray10", "#DCE4EE"),command=self.uploadEvent,text="Upload")
        ...
        self.sidebar_button_1.configure(text="Home")
